    ...
    <div className="min-h-screen text-neutral-800 dark:text-neutral-200 relative isolate">
      ...
      <main className="container mx-auto px-4 py-6 sm:py-12">
        <div className="flex justify-center mb-8">
          <div className="relative flex p-1 bg-black/5 dark:bg-white/5 backdrop-blur-md rounded-xl shadow-inner border border-white/30 dark:border-black/30" role="tablist">
            <span 
            ...
            <button 
                ...
                className={`relative z-10 px-4 sm:px-5 py-2 font-semibold rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500/75 transition-colors duration-300 ${activeView === 'sgpa' ? 'text-neutral-900 dark:text-white' : 'text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}
                role="tab"
            ...
            <button 
                ...
                className={`relative z-10 px-4 sm:px-5 py-2 font-semibold rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500/75 transition-colors duration-300 ${activeView === 'cgpa' ? 'text-neutral-900 dark:text-white' : 'text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}
                role="tab"
