    ...
    <div className="min-h-screen text-neutral-800 dark:text-neutral-200 relative isolate">
      ...
      <main className="container mx-auto px-4 py-4 sm:py-10">
        ...
        <div className="text-center mb-6 sm:mb-8">
            <h3 className="flex items-center justify-center gap-2 text-sm sm:text-lg font-medium tracking-wide text-neutral-500 dark:text-neutral-400">
                <ElectricIcon className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-500 dark:text-yellow-400 flex-shrink-0" />
